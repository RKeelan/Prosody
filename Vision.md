...
- Shell/content split: the app is a static website hosted on GitHub Pages, built once. Each poem is a JSON data pack conforming to a shared schema (poem text, sentence segmentation, pronoun antecedents, scansion, glossary, device instances, allusion cards, model argument, active-activity flags).
