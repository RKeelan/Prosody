...
and each lower layer adds a coloured strip—the first underlining the word, a
second overlining it—so no toggled-on layer hides beneath another. The per-mark
chips stay the way any single mark is removed.
